...
/*
	...
	const [modalIsOpenNuevoProyecto, setIsOpenNuevoProyecto] = React.useState(false);
		...
		function openModalLoad() { 
			...
			setIsOpenLoad(false); 
			 ...
			 function openModalNuevoProyecto() {
				setIsOpenNuevoProyecto(true);
			  }
			  function closeModalNuevoProyecto() {
				setIsOpenNuevoProyecto(false);
			  }
	
			  function afterOpenModalNuevoProyecto() {
...
async function getAllColaboradoresdelProyecto(proyecto){    
		...
		var channel = pusher.subscribe('my-channel'); 
			channel.bind('my-event', function(data) { 
				...
				if(data.userid === props.userid && data.tipo === "act"){   
					getActividadesProyecto(IdProyecto, NProyecto);
	...
	async function MostrarDetalleProyecto(folio, folioresponsable, name){
	  ...
	  async function addActividad(){  
		...
		if((IdProyecto != "Seleccione") && (actividad.length > 1)){
		let fd = new FormData() 
		fd.append("id","addActividad") 
		fd.append("folioproyecto",IdProyecto) 
...
async function actualizarFecha(folio) {
  ...
  >
	<h2 ref={(_subtitle) => (subtitle = _subtitle)} style={{color:'black'}}>Nueva Actividad {NProyecto}</h2>
...
/>
	...
	<button onClick={closeModal} class="btn btn-outline-danger btn-sm ">Cerrar</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			>
				...
				<div>Actualizar responsable</div> 
		...
		<Modal
			isOpen={modalIsOpenNuevoProyecto}
			onAfterOpen={afterOpenModalNuevoProyecto}
			onRequestClose={closeModalNuevoProyecto}
			style={customStyles}
			contentLabel="Example Modal"
		>
		...
		<br></br>
		<br></br>
			<button onClick={closeModalNuevoProyecto} class="btn btn-outline-danger btn-sm " style={{ height:'45px'}}>Cancelar</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
